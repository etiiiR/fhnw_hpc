    ...
    def process_bus_data(self, topic="bus_data"):
        ...
        while True:
            ...
            if service_probability is not None and service_probability >= 0.8:
                ...
                BusServiceResetter('localhost:19092,localhost:19093,localhost:19094').reset_bus_service(bus_id)
                self.service_probabilities[bus_id] = []
...
if __name__ == "__main__":
    smart_bus_processor = SmartBusProcessor('localhost:19092,localhost:19093,localhost:19094')
