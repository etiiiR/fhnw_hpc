...
class SmartBus:
    def __init__(self, servers, bus_id):
    ...
    def send_bus_data(self, topic="bus_data"):
        ...
        while True:
            ...
            time.sleep(5)  # Sleep for 1 second to maintain a 10 messages per second rate
            self.producer.flush()

if __name__ == "__main__":
    bus_id = os.getenv("BUS_ID", "default_bus_id")  # Use a default or raise an error if you prefer
    smart_bus = SmartBus(servers, bus_id=bus_id)
